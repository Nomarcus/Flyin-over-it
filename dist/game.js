...
function selectMissions(){
 mode='select';$('menu').hidden=true;showModal('NORDIC AIR RESCUE','Seven calls. Your helicopter.','<div class="missionlist operations" id="missionList"></div><p>All seven are open. Fly at your own pace; improve your precision and star rating on each return.</p>',[{text:'MAIN MENU',run:toMenu}]);
